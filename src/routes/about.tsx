  ...
  return (
    <main>
      <Section
        ...
        lead="Kof é uma linguagem de programação geral, fortemente tipada e estaticamente tipada, com compilador próprio, Kof IR e múltiplos backends. Está em desenvolvimento ativo — a primeira estável (0.1.0) já saiu e o dia a dia segue na 0.4.1-beta — e este site se compromete a não transformar isso em promessa vazia."
      >
